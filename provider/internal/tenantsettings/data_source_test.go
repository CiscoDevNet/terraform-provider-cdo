		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.cdo_tenant_settings.test", "web_analytics_enabled", "true"),
					...
					resource.TestCheckResourceAttr("data.cdo_tenant_settings.test", "multi_cloud_defense_enabled", "true"),
					resource.TestCheckResourceAttr("data.cdo_tenant_settings.test", "auto_discover_on_prem_fmcs_enabled", "true"),
